...
This bot uses both prefix and slash commands. The default prefix was previously `>`, however due to recent Discord changes, the bot now uses mention-based message commands.

Use `@Clueless help` or `/help` on a server with Clueless to see the list of commands
