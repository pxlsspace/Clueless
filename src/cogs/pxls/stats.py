...
class PxlsStats(commands.Cog):
    ...
    @cog_ext.cog_slash(name="generalstats",description="Show some general stats about the canvas.",
        guild_ids=GUILD_IDS)
    ...
    async def userinfo(self,ctx,name=None):
        ...
        if last_15m == None and last_30m == None:
            status = "???"
            status_emoji = ""
    ...
    @cog_ext.cog_slash(name="canvashighlight",
