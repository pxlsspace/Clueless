...
PALETTES = [
    ...
    {
        "names": ["browns", "beiges"],
        "colors": PXLS_COLORS[6:11],
    },
    {
        "names": ["pinks", "purples", "mauves"],
        "colors": PXLS_COLORS[11:16],
    },
    {
        "names": ["blues"],
        "colors": PXLS_COLORS[16:20],
    },
    {
        "names": ["teals"],
        "colors": PXLS_COLORS[19:22],
    },
    {
        "names": ["greens"],
        "colors": PXLS_COLORS[22:26],
    },
    {
        "names": ["oranges", "yellows"],
        "colors": PXLS_COLORS[26:30],
    },
    {
        "names": ["reds"],
        "colors": PXLS_COLORS[30:],
    },
    {
